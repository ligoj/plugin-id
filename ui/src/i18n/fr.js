...
export default {
  ...
  'company.subtitle': "Gérez les entités et leur annuaire.",
  'containerScope.deleteConfirmAfter': " ?",
  'containerScope.deleteConfirmBefore': "Êtes-vous certain de supprimer ",
  'containerScope.subtitle': "Définissez les bases LDAP des groupes et entités.",
  'delegate.searchPlaceholder': "Rechercher une délégation…",
  'delegate.subtitle': "Déléguez des droits d'administration et d'écriture.",
  'group.searchPlaceholder': "Rechercher un groupe…",
  'group.subtitle': "Organisez les groupes et leurs membres.",
  'user.searchPlaceholder': "Rechercher un utilisateur…",
  'user.subtitle': "Gérez les comptes, leurs entités, groupes et accès.",
}
